...
public final class OptimizedTheme implements com.lukflug.panelstudio.theme.ITheme {
	/**
	 * The theme to be wrapped.
	 */
	private final com.lukflug.panelstudio.theme.ITheme theme;
	/**
	 ...
	 */
	private final Map<ParameterTuple<Class<?>,Void>, com.lukflug.panelstudio.theme.IPanelRenderer<?>> panelRenderer=new HashMap<>();
	/**
	 ...
	 */
	private final Map<ParameterTuple<Void,Boolean>, com.lukflug.panelstudio.theme.IRadioRenderer> radioRenderer=new HashMap<>();
	/**
	 * Resize renderer.
	 */
