 ...
 */
@FunctionalInterface
public interface IThemeMultiplexer extends com.lukflug.panelstudio.theme.ITheme {
	@Override
	...
	@Override
	public default <T> com.lukflug.panelstudio.theme.IButtonRenderer<T> getButtonRenderer (Class<T> type, int logicalLevel, int graphicalLevel, boolean container) {
		IButtonRendererProxy<T> proxy=()->getTheme().getButtonRenderer(type,logicalLevel,graphicalLevel,container);
		return proxy;
	}
	
	@Override
	public default com.lukflug.panelstudio.theme.IButtonRenderer<Void> getSmallButtonRenderer (int symbol, int logicalLevel, int graphicalLevel, boolean container) {
	...
	@Override
	public default com.lukflug.panelstudio.theme.ISwitchRenderer<Boolean> getToggleSwitchRenderer (int logicalLevel, int graphicalLevel, boolean container) {
